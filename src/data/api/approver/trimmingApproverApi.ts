...
export type TrimmingApproverMotorChangeStatusPayload = {
  formId: string;
  motorId: string;
...
export type TrimmingApproverMotorChangeStatusResponse = {
  formId: string;
  batchId: string;
  motorId: string;
  actionType: string;
...
export const changeTrimmingApproverMotorStatus = async (
