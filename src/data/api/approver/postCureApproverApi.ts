...
export type PostCureApproverMotorChangeStatusPayload = {
  formId: string;
  motorId: string;
...
export type PostCureApproverMotorChangeStatusResponse = {
  formId: string;
  batchId: string;
  motorId: string;
  actionType: string;
...
export const changePostCureApproverMotorStatus = async (
