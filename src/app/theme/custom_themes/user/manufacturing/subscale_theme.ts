...
export const getSubscaleTheme = (baseTheme: any) => {
  ...
  const accentColor = palette.primaryLight ?? SUBSCALE_BRAND.ssLight;
  ...
  return {
    ...
    details: {
      bannerStatusConfig: (() => {
        const primary = palette.primary ?? SUBSCALE_BRAND.ss;
        const primaryLight = palette.primaryLight ?? SUBSCALE_BRAND.ssLight;
        const success = palette.accent ?? SUBSCALE_BRAND.accent;
      ...
      document: {
        ...
        boxShadow: `0 4px 24px ${alpha(palette.primary ?? SUBSCALE_BRAND.ss, 0.08)}`,
        overflow: "hidden",
      ...
      section: {
        ...
        p: 2,
        borderRadius: 2,
        border: `1px solid ${alpha(palette.border ?? SUBSCALE_BRAND.border, 0.65)}`,
        background: palette.pageBg ?? "#fff",
      },
      sectionTitle: {
        fontSize: "0.72rem",
        ...
        color: palette.primaryLight ?? SUBSCALE_BRAND.ssLight,
        mb: 1.5,
        display: "flex",
        alignItems: "center",
        gap: 0.75,
      ...
      metaItem: {
        p: 1.25,
        borderRadius: 1.5,
        background: alpha(palette.primaryLight ?? SUBSCALE_BRAND.ssLight, 0.04),
        border: `1px solid ${alpha(palette.primaryLight ?? SUBSCALE_BRAND.ssLight, 0.12)}`,
      },
      metaLabel: {
        fontSize: "0.62rem",
        fontWeight: 700,
        ...
        textTransform: "uppercase",
        color: palette.textSub ?? SUBSCALE_BRAND.textSub,
      },
      metaValue: {
        fontSize: "0.88rem",
        fontWeight: 700,
        color: palette.text ?? SUBSCALE_BRAND.text,
        mt: 0.35,
      },
      blockWrapper: (isLast: boolean) => ({ mb: isLast ? 0 : 2.5 }),
      blockMeta: { fontSize: "0.72rem", color: palette.textSub ?? SUBSCALE_BRAND.textSub },
      blockMetaStrong: { color: palette.text ?? SUBSCALE_BRAND.text, fontWeight: 700 },
      materialChip: {
        height: 22,
        fontSize: "0.68rem",
        fontWeight: 800,
      ...
      tableCell: { fontSize: "0.82rem", py: 1.1, px: 1.5, color: palette.text ?? SUBSCALE_BRAND.text },
      specText: { fontWeight: 600 },
      resultText: { fontWeight: 600, color: palette.text ?? SUBSCALE_BRAND.text },
      remarksText: { fontSize: "0.8rem", color: palette.textSub ?? SUBSCALE_BRAND.textSub },
      emptyText: {
        fontSize: "0.85rem",
        color: palette.textSub ?? SUBSCALE_BRAND.textSub,
        textAlign: "center",
    ...
    flowBar: {
      ...
      selectInput: (hasValue: boolean) => ({
        "& .MuiOutlinedInput-root": {
          ...
          "& fieldset": {
            borderColor: alpha(palette.border ?? SUBSCALE_BRAND.border, 0.95),
          },
          "&:hover fieldset": {
