...
export const STRINGS = {
  ...
  SOURCING: {
    ...
    SPECIFICATION_FORM: {
      ...
      LOADING_APPROVED_LOTS: "Loading approved lots...",
      SELECT_LOT_PLACEHOLDER: "Select lot",
      NO_APPROVED_LOTS: "No approved lots for this material",
      ...
      ADDUCT_PREPARATION: {
        ...
        ADDUCT_BATCH_PREP_DATE: "Date of preparation of ADDUCT batch",
        TMP_MFG_LOT_NO: "Mfg / Lot no of TMP used",
        TMP_TOTAL_QTY_GM: "Total Qty (gm) of TMP used",
        NBD_MFG_LOT_NO: "Mfg / Lot no of nBD used",
        NBD_TOTAL_QTY_GM: "Total Qty (gm) of nBD used",
        RPM: "RPM",
        PROCESS_TEMP: "Process temp",
        JACKET_TEMP: "Jacket temp",
        PROCESS_START_TIME: "Process start time",
        PROCESS_END_TIME: "Process end time",
        FINAL_ADDUCT_QTY: "Final quantity of adduct preparation",
        DISPATCH_DATE_TIME: "Date time of dispatch",
        adductBatchPrepDate: {
          required: "Adduct batch preparation date is required",
          invalid: "Enter a valid date",
        },
        tmpMfgLotNo: {
          required: "TMP mfg / lot no is required",
          invalid: "Use letters, numbers, spaces, hyphens, underscores, or slashes only",
        },
        tmpTotalQtyGm: {
          required: "TMP total quantity is required",
          invalid: "Enter a valid number",
        },
        nbdMfgLotNo: {
          required: "nBD mfg / lot no is required",
          invalid: "Use letters, numbers, spaces, hyphens, underscores, or slashes only",
        },
        nbdTotalQtyGm: {
          required: "nBD total quantity is required",
          invalid: "Enter a valid number",
        },
        rpm: {
        ...
        processStartTime: {
          required: "Process start time is required",
          invalid: "Enter a valid date and time",
        },
        processEndTime: {
          required: "Process end time is required",
          invalid: "Enter a valid date and time",
        },
        finalAdductQty: {
          required: "Final adduct quantity is required",
          invalid: "Enter a valid number",
        },
        dispatchDateTime: {
          required: "Dispatch date time is required",
          invalid: "Enter a valid date and time",
        },
      },
      HTPB_BLENDING_PREPARATION: {
        SECTION_TITLE: "HTPB blending preparation details",
  ...
  MANUFACTURING: {
    ...
    CASTING_CURING: {
      ...
      SUBMIT_VALIDATION_FAILED:
        "Complete all required fields before submitting. Check the Casting and Curing tabs for highlighted errors.",
      CURING_REQUIRED_BEFORE_SUBMIT:
        "Load and complete the curing section before submitting this motor.",
  ...
  MASTER_DATA: {
    PAGE: {
      ...
      NEW_BUTTON_FOR_TYPE: (typeLabel: string) => `Add New ${typeLabel}`,
      LOADING_PLACEHOLDER: "…",
    ...
    TABLE: {
      ...
      COL_UPDATED_ON: "Updated On",
      COL_ACTIONS: "Enable/Disable",
      YES: "Yes",
      NO: "No",
      EDIT: "Edit",
      VIEW: "View",
    ...
    MATERIALS: {
      SEARCH_PLACEHOLDER: "Search by code or name…",
      VIEW_TITLE: "Raw material details",
      VIEW_SUBTITLE: (name: string) => `Material: ${name}`,
      VIEW_EMPTY: "No grades or specifications defined.",
      VIEW_TOP_LEVEL_SPECS: "Top-level specifications",
      VIEW_NO_SPECS: "No specifications",
      VIEW_COL_NAME: "Name",
      VIEW_COL_RANGE: "Reference range",
      VIEW_COL_STATUS: "Status",
      EDIT_NESTED_HINT:
    ...
    INSULATION_SPEC: {
      COL_INSULATION_TYPE: "Insulation Type",
      CREATE_SUBTITLE: "Enter insulation type, categories, and parameters.",
      SEARCH_PLACEHOLDER: "Search by insulation type…",
      VIEW_TITLE: "Insulation specification details",
      VIEW_SUBTITLE: (type: string) => `Insulation type: ${type}`,
      VIEW_EMPTY: "No categories or parameters defined.",
      VIEW_NO_PARAMETERS: "No parameters in this category.",
      VIEW_COL_NAME: "Name",
      VIEW_COL_RANGE: "Reference range",
      VIEW_COL_STATUS: "Status",
      EDIT_NESTED_HINT:
        "Existing categories and parameters can only be enabled or disabled. Add new rows to extend this specification.",
    },
    QUALITY_CHECKS: {
      SEARCH_PLACEHOLDER: "Search by code, mix type, or stage…",
      MOTOR_STAGE_FILTER_LABEL: "Motor stage",
      MOTOR_STAGE_FILTER_PLACEHOLDER: "All stages",
      MIX_TYPE_FILTER_LABEL: "Mix type",
      MIX_TYPE_FILTER_PLACEHOLDER: "All mix types",
      MOTOR_STAGE_SELECT_PLACEHOLDER: "Select motor stage",
      MIX_TYPE_SELECT_PLACEHOLDER: "Select mix type",
      COL_MIX_TYPE: "Mix type",
      COL_MOTOR_STAGE: "Motor stage",
      COL_PARAMETERS: "Parameters",
      CREATE_SUBTITLE: "Select mix type and motor stage, then define quality check parameters.",
      EDIT_SUBTITLE: (name: string) => `Updating: ${name}`,
      EDIT_NESTED_HINT:
        "Existing parameters cannot be changed or removed. Add new parameters below or toggle active state.",
      VIEW_TITLE: "Quality check details",
      VIEW_SUBTITLE: (name: string) => `Quality check: ${name}`,
      VIEW_NO_PARAMETERS: "No parameters defined.",
      PARAMETERS: "Parameters",
      ADD_PARAMETER: "Add parameter",
      REMOVE_PARAMETER: "Remove parameter",
      PARAM_NAME: "Parameter name",
      PARAM_SAMPLES: "No of Samples",
      PARAM_MIN: "Min",
      PARAM_MAX: "Max",
      PARAM_UNIT: "Unit",
    },
    CURING_CYCLES: {
      ...
      VIEW_TITLE: "Curing cycle details",
      VIEW_SUBTITLE: (name: string) => `Curing cycle: ${name}`,
      VIEW_NO_STEPS: "No cycle steps defined.",
      CYCLE_STEPS: "Cycle steps",
      ADD_STEP: "Add cycle step",
    ...
    ENABLE_DIALOG: {
      TITLE: "Enable master record?",
      BODY: (name: string) =>
        `"${name}" will be shown in dropdowns again and available for new entries.`,
      CONFIRM: "Enable",
      ENABLING: "Enabling…",
    },
    TOGGLE_ITEM_DIALOG: {
      ...
      ENABLE_BODY: (name: string) => `Enable "${name}"?`,
      DISABLE_BODY: (name: string) => `Disable "${name}"? It will be hidden from dropdowns.`,
    ...
    FORM: {
      ...
      CREATE_SUBTITLE: "Enter values below. Required fields are marked with *.",
      EDIT_SUBTITLE: (name: string) => `Updating: ${name}`,
      CANCEL: "Cancel",
      SAVE: "Save",
      SAVING: "Saving…",
      ACTIVE_LABEL: "Enable / Disable",
    },
    MESSAGES: {
