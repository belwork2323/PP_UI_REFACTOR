  ...
  MANUFACTURING: {
    ...
    RAW_MATERIAL_PREP: {
      ...
      FINAL_APPROVAL_DIALOG_INFO:
        "Unless all premixes are approved, you cannot proceed for final approval.",
    ...
    CASE_PREP: {
      ...
      SCHEMA_LOAD_ERROR: "Schema failed to load. Please try again.",
      BATCH_DETAILS_LOADING: "Loading batch details from identification sheet...",
      FORM_OPENING_TITLE: "Opening Case Preparation",
      FORM_OPENING_MESSAGE:
        "Loading batch details, schema, and form data. This will only take a moment…",
      ...
      FINAL_APPROVAL_DIALOG_TITLE: "Submit for Final Approval",
      FINAL_APPROVAL_DIALOG_INFO:
        "Review motor statuses below. You can proceed only when every motor is Approved.",
      FINAL_APPROVAL_PROCEED: "Proceed for Approval",
      FINAL_APPROVAL_CLOSE: "Close",
    ...
    MIXING: {
      ...
      FINAL_APPROVAL_DIALOG_TITLE: "Submit for Final Approval",
      FINAL_APPROVAL_DIALOG_INFO:
        "Review every Premix and Final Mix card status below. Proceed only when all cards are approved.",
      FINAL_APPROVAL_PROCEED: "Proceed for Approval",
      FINAL_APPROVAL_CLOSE: "Close",
  ...
  QUALITY_CONTROL: {
    ...
    QC_DIVISION: {
      ...
      PROPELLANT_MOTOR_NAV_HINT:
        "Fill propellant property details for the selected motor. Add another process from the picker row to append it below the existing entries for the same motor.",
