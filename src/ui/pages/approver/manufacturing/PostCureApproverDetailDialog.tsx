...
import PostCureApproverReviewContent from "./PostCureApproverReviewContent";
...
type PostCureApproverDetailDialogProps = {
  ...
  onFormApprove?: (item: PostCureApproverDetailItem) => void;
  onFormReject?: (item: PostCureApproverDetailItem) => void;
      ...
      <Dialog open={open} onClose={onClose} maxWidth="lg" fullWidth PaperProps={{ sx: theme.dialog.paper }}>
        ...
        <DialogContent sx={theme.dialog.content}>
          <PostCureApproverReviewContent
            ...
            onFormApprove={onFormApprove ? () => onFormApprove(item) : undefined}
            onFormReject={onFormReject ? () => onFormReject(item) : undefined}
