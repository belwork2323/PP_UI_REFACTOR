...
const DimensionalParametersTableToolbar = ({
  search,
  onSearchChange,
  projectFilter,
  ...
  return (
    ...
    >
      <TextField
        ...
        placeholder={S.DIMENSIONAL_PARAMETERS.SEARCH_PLACEHOLDER}
        sx={{
      ...
      <Box sx={{ minWidth: 200, maxWidth: 280, flex: "0 0 240px" }}>
        <AppSearchableDropdown
          label={S.DIMENSIONAL_PARAMETERS.PROJECT_FILTER_LABEL}
          value={projectFilter}
          onChange={onProjectFilterChange}
          options={projectOptions}
          loading={projectLoading}
          placeholder={S.DIMENSIONAL_PARAMETERS.PROJECT_FILTER_PLACEHOLDER}
          filterPanel
          fullWidth
          size="small"
          sx={filterFieldSx}
      ...
      <Box sx={{ minWidth: 160, maxWidth: 220, flex: "0 0 180px" }}>
        <AppSearchableDropdown
          label={S.DIMENSIONAL_PARAMETERS.MOTOR_STAGE_FILTER_LABEL}
          value={motorStageFilter}
          onChange={onMotorStageFilterChange}
          options={motorStageOptions}
          loading={motorStageLoading}
          placeholder={S.DIMENSIONAL_PARAMETERS.MOTOR_STAGE_FILTER_PLACEHOLDER}
          filterPanel
          fullWidth
          size="small"
          sx={filterFieldSx}
...
export default DimensionalParametersTableToolbar;
