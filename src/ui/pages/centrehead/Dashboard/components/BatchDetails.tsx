...
export default function BatchDetailPopup({ batch, stageConfig, onClose, t }) {
  ...
  }, [data?.batchId, activeStageMeta?.departmentId, fetchSubDeptStages, resetSubDeptStages]);
  ...
  return (
    <Modal open disableAutoFocus onClose={onClose} sx={t.popup.modal}>
      <Box role="dialog" aria-modal="true" onClick={(e) => e.stopPropagation()} sx={t.popup.paper}>
        <Box sx={ph.wrapper}>
