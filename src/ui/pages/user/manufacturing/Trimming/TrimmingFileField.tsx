...
import {
  useTrimmingFileActions,
  type TrimmingFileAcceptMode,
} from "../../../../../hooks/user/manufacturing/useTrimmingFileActions";
...
type TrimmingFileFieldProps = {
  ...
  multiple?: boolean;
  acceptMode?: TrimmingFileAcceptMode;
  label?: string;
  disabled?: boolean;
  readOnly?: boolean;
  compact?: boolean;
...
const acceptForMode = (mode: TrimmingFileAcceptMode) =>
...
const TrimmingFileField = ({
  ...
  const {
    ...
    closeFilePreview,
    downloadFilePreview,
  } = useTrimmingFileActions(list, onChange, { acceptMode });
