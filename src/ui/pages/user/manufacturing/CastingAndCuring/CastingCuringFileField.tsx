...
import {
  useCastingCuringFileActions,
  type CastingCuringFileAcceptMode,
} from "../../../../../hooks/user/manufacturing/useCastingCuringFileActions";
...
type CastingCuringFileFieldProps = {
  ...
  multiple?: boolean;
  acceptMode?: CastingCuringFileAcceptMode;
  label?: string;
  disabled?: boolean;
  readOnly?: boolean;
  compact?: boolean;
...
const acceptForMode = (mode: CastingCuringFileAcceptMode) =>
...
const CastingCuringFileField = ({
  ...
  const {
    ...
    closeFilePreview,
    downloadFilePreview,
  } = useCastingCuringFileActions(list, onChange, { acceptMode });
