...
const MixingList = ({ hookState, rowsPerPageOptions }: any) => {
  ...
  return (
    <UserSubdepartmentBatchListSection
      ...
      statusLabel={S.MIXING.COL_OPERATION_STATUS}
      rawStatusConfig={MX_STATUS_CONFIG}
      statusMap={OPERATION_STATUS}
      tableLabel={S.MIXING.TABLE_LABEL}
      onViewDetails={hookState.handleViewMixingDetails}
      PersonIcon={PersonRoundedIcon}
      CalendarIcon={CalendarMonthRoundedIcon}
      viewDetailsTooltip={S.MIXING.VIEW_DETAILS_TOOLTIP}
    />
  );
};
